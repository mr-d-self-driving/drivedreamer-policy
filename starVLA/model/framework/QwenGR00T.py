...
if __name__ == "__main__":
    ...
    cfg.framework.qwenvl.base_vlm = os.environ.get("BASE_VLM", "/path/to/qwen/model")
    ...
    # Create a sample
    sample = {
        "action": np.random.uniform(-1, 1, size=(16, 2)).astype(np.float16), # action_chunk, action_dim
        "image": [image, image], # two views
        "lang": "This is a fake for testing.",
        "state" : np.random.uniform(-1, 1, size=(1, 2)).astype(np.float16), # chunk, state_dim
    }
